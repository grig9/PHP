                            ...
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php 
                                    $posts = [
                                        [
                                            "header" => "Privacy",
                                            "some_important_text" => "Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
                                ...
                                <?php foreach($posts as $post): ?>
                                    ...
                                    <p class="mb-g">
                                        <?php echo $post['some_important_text'] ;?>
                                    </p>     
