                        ...
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                                ...
                                <?php foreach($authors as $author): ?>
                                    <div class="<?php  echo ($author['is_banned']) ? 'banned ' : '' ;?>rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
